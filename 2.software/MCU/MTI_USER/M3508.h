...
//用户ID定义
#define DOG_LEGLF_1_ID 0x201 //Dog_Leg左前腿电机配置ID口
#define DOG_LEGLF_2_ID 0x202 //Dog_Leg左前腿电机配置ID口
#define DOG_LEGRF_3_ID 0x203 //Dog_Leg右前腿电机配置ID口
#define DOG_LEGRF_4_ID 0x204 //Dog_Leg右前腿电机配置ID口

#define DOG_LEGLB_1_ID 0x201 //Dog_Leg左后腿电机配置ID口
#define DOG_LEGLB_2_ID 0x202 //Dog_Leg左后腿电机配置ID口
#define DOG_LEGRB_3_ID 0x203 //Dog_Leg右后腿电机配置ID口
#define DOG_LEGRB_4_ID 0x204 //Dog_Leg右后腿电机配置ID口
...
extern M3508_TypeDef Dog_Leglf1;//Dog_Leg左前腿电机配置ID口
extern M3508_TypeDef Dog_Leglf2;//Dog_Leg左前腿电机配置ID口
extern M3508_TypeDef Dog_LegRf3;//Dog_Leg右前腿电机配置ID口
extern M3508_TypeDef Dog_LegRf4;//Dog_Leg右前腿电机配置ID口

extern M3508_TypeDef Dog_Leglb1;//Dog_Leg左后腿电机配置ID口
extern M3508_TypeDef Dog_Leglb2;//Dog_Leg左后腿电机配置ID口
extern M3508_TypeDef Dog_LegRb3;//Dog_Leg右后腿电机配置ID口
extern M3508_TypeDef Dog_LegRb4;//Dog_Leg右后腿电机配置ID口
